/*
 * *** Please do not edit ! ***
 * @(#) Available_Indexs_1.cs
 * @procedure availableIndexs/1 in logic.pl
 */
...
public class Available_Indexs_1 : Predicate {
    static internal readonly SymbolTerm f1 = SymbolTerm.MakeSymbol("availableIndexs", 1);

    public Term arg1;

    public Available_Indexs_1(Term a1, Predicate cont) {
        arg1 = a1; 
        this.cont = cont;
    }

    public Available_Indexs_1(){}
